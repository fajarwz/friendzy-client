<template>
  <div class="container mx-auto mt-16 sm:px-6 lg:px-8">
    <form @submit.prevent="register" class="bg-green-500 rounded mx-auto px-6 py-6 w-1/2">
      ...
      <div class="text-center mt-3">
        <green-button type="submit">Register</green-button>
      </div>
    </form>
  </div>
</template>
...
export default {
  ...
  head: {
    title: "Register",
    meta: [{ hid: "description", name: "description", content: "Registration page" }],
  },
  data: () => ({
    form: {
      name: "",
